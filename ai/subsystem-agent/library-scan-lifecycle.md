...
- Database scan metrics separate staging, publication, obsolete-generation cleanup, and WAL growth. Keep these phases distinct when evaluating background cleanup or checkpoint policy.
